 ...
 */
export function autoScrollTop(scrollContainer) {
 ...
 * @param {String} key
 */
export function ignoreCityData(items, key) {
    return items.filter(item => process.env.VUE_APP_IGNORE_CITY_DATA.indexOf(item[key]) < 0);
}
