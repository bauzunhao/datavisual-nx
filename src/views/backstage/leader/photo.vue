<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                 label-width="110px">
            <el-form-item label="包案领导姓名" prop="leaderName">
                <el-input
            ...
            <el-form-item label="包案日期" prop="leaderTime">
                <el-date-picker
                    v-model="leaderTime"
                    style="width: 240px"
                    unlink-panels
...
<script>
    ...
    import {listSetting, updateSetting} from "@/api/backstage/leader/photo";
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                this.loading = true;
                listSetting(this.addDateRange(this.queryParams, this.leaderTime)).then(response => {
