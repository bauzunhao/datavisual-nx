<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="85px">
      ...
      <el-form-item label="内容：" class="flexstart">
            <el-input
      ...
      <el-row class="butlist">
          <el-col :span="12">
              <el-form-item label="办理状态：" class="flexstart">
                  <el-radio-group v-model="queryParams.status" size="small">
                      <el-radio-button label="">全部</el-radio-button>
                      <el-radio-button label="0">待办理</el-radio-button>
                      <el-radio-button label="1">办理中</el-radio-button>
                      <el-radio-button label="2">已办结</el-radio-button>
                  </el-radio-group>
              </el-form-item>
          </el-col>
          <el-col :span="12">
              <el-form-item label="反映类型：" class="flexstart">
                  <el-radio-group v-model="queryParams.type" size="small">
                      <el-radio-button label="">全部</el-radio-button>
                      <el-radio-button label="0">建议</el-radio-button>
                      <el-radio-button label="1">投诉</el-radio-button>
                  </el-radio-group>
              </el-form-item>
          </el-col>
          <el-col :span="12">
              <el-form-item label="评价状态：" class="flexstart">
                  <el-radio-group v-model="queryParams.pjStatus" size="small">
                      <el-radio-button label="">全部</el-radio-button>
                      <el-radio-button label="0">未评价</el-radio-button>
                      <el-radio-button label="1">已评价</el-radio-button>
                  </el-radio-group>
              </el-form-item>
          </el-col>
          <el-col :span="12">
              <el-form-item label="评价结果：" class="flexstart">
                  <el-radio-group v-model="queryParams.pjResult" size="small">
                      <el-radio-button label="">全部</el-radio-button>
                      <el-radio-button label="0">满意</el-radio-button>
                      <el-radio-button label="1">基本满意</el-radio-button>
    ...
    <el-dialog :title="title" :visible.sync="open" width="900px" append-to-body>
        <el-descriptions class="margin-top" :column="3">
            ...
            <el-descriptions-item label="办结时间">{{this.complaint.endTime?parseTime(this.complaint.endTime, '{y}-{m}-{d}'):""}}</el-descriptions-item>
        </el-descriptions>
        <el-descriptions
            class="margin-top"
            :column="1"
...
<script>
import { listComplaint, getComplaint,updateComplaint,stateList} from "@/api/backstage/grid/complaint";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.queryParams = this.addDateRange(this.queryParams, this.endDateRange,"EndDate");
      listComplaint(this.addDateRange(this.queryParams, this.pjDateRange,"PjDate")).then(response => {
    ...
    resetQuery() {
      ...
      this.queryParams.pjStatus = "";
      this.queryParams.pjResult = "";
      this.handleQuery();
    },
    // 多选框选中数据
    ...
    handleExport() {
          ...
          this.download('grid/complaint/export', {
              ...this.queryParams
          }, `网格查询数据管理_${new Date().getTime()}.xlsx`,{timeout:120000});
      },
  }
};
</script>
